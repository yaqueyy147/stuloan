 ...
 */
public class AlipayTrade_repay {
    private static Log                  log = LogFactory.getLog(AlipayTrade_repay.class);
    ...
    public static void main(String[] args) {
        AlipayTrade_repay main = new AlipayTrade_repay();
    ...
    public static String test_trade_precreate(Repayorder order, List<GoodsDetail> goodsDetailList, HttpServletRequest request) {
        ...
        switch (result.getTradeStatus()) {
            case SUCCESS:
                ...
                String imgpath = "/static/alipay/repay/qr-%s.png";
                String path = request.getSession().getServletContext().getRealPath("");
                path = path.substring(0,path.indexOf("\\webapp") + 7);
                path = path + imgpath;
